...
const fuse = new Fuse(
  [
    ...
    'client.parsing.get',
    'client.parsing.list',
    'client.extraction.run',
    'client.extraction.jobs.create',
    'client.extraction.jobs.file',
    'client.extraction.jobs.get',
    'client.extraction.jobs.getResult',
    'client.extraction.jobs.list',
    'client.extraction.runs.delete',
    'client.extraction.runs.get',
    'client.extraction.runs.getByJob',
    'client.extraction.runs.list',
    'client.extraction.extractionAgents.create',
    'client.extraction.extractionAgents.delete',
    'client.extraction.extractionAgents.get',
    'client.extraction.extractionAgents.list',
    'client.extraction.extractionAgents.update',
    'client.extraction.extractionAgents.schema.generateSchema',
    'client.extraction.extractionAgents.schema.validateSchema',
    ...
    'client.beta.agentData.agentData',
    ...
    'client.beta.parseConfigurations.create',
    'client.beta.parseConfigurations.delete',
    'client.beta.parseConfigurations.get',
    'client.beta.parseConfigurations.list',
    'client.beta.parseConfigurations.update',
    ...
    'client.beta.batch.cancel',
    'client.beta.batch.create',
