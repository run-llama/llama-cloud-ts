...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: LlamaCloud): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: LlamaCloud): Logger {
