...
export class Parsing extends APIResource {
   ...
   */
  create(params: ParsingCreateParams, options?: RequestOptions): APIPromise<ParsingJob> {
  ...
  get(
    ...
    return this._client.get(path`/api/v2alpha1/parse/${jobID}/result`, { query, ...options });
  }
 ...
 *
 * The metadata field is always present. Other fields are only included if
 * requested via the corresponding flags in ParseResultRequest.
 */
export interface ParsingGetResponse {
   ...
   */
  json_output?: { [key: string]: unknown } | null;
   ...
   */
  structured?: ParsingGetResponse.Structured | null;
...
export namespace ParsingGetResponse {
  ...
  export interface Structured {
     ...
     */
    pages: Array<Structured.StructuredResultPage | Structured.FailedStructuredPage>;
  }
...
export interface ParsingCreateParams {
   ...
   */
  version?: '2025-12-11' | 'latest' | (string & {});
