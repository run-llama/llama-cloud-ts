...
describe('resource pipelines', () => {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.pipelines.list({
    organization_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  ...
  test.skip('getStatus: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.pipelines.getStatus('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { full_details: true }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(LlamaCloud.NotFoundError);
  });
