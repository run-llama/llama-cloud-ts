...
describe('resource batches', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.v1.beta.batches.create({
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.v1.beta.batches.create({
      external_id: 'external_id',
      input_id: 'input_id',
      input_type: 'input_type',
      body_project_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.v1.beta.batches.retrieve('batch_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.beta.batches.retrieve(
        'batch_id',
        { organization_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' },
  ...
  test.skip('list', async () => {
    const responsePromise = client.v1.beta.batches.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
