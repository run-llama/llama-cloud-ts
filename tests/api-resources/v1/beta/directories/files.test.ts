...
describe('resource files', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.v1.beta.directories.files.retrieve('directory_file_id', {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.v1.beta.directories.files.update('directory_file_id', {
      directory_id: 'directory_id',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('list', async () => {
    const responsePromise = client.v1.beta.directories.files.list('directory_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.beta.directories.files.list(
        'directory_id',
        {
          display_name: 'display_name',
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.v1.beta.directories.files.delete('directory_file_id', {
      directory_id: 'directory_id',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('add: only required params', async () => {
    const responsePromise = client.v1.beta.directories.files.add('directory_id', { file_id: 'file_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
