...
describe('resource jobs', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.v1.extraction.jobs.create({
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.v1.extraction.jobs.create({
      extraction_agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      file_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      from_ui: true,
      config_override: {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.v1.extraction.jobs.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: only required params', async () => {
    const responsePromise = client.v1.extraction.jobs.list({
      extraction_agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('list: required and optional params', async () => {
    const response = await client.v1.extraction.jobs.list({
      extraction_agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    });
  });
  ...
  test.skip('batch: only required params', async () => {
    const responsePromise = client.v1.extraction.jobs.batch({
      extraction_agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  ...
  test.skip('batch: required and optional params', async () => {
    const response = await client.v1.extraction.jobs.batch({
      extraction_agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      file_ids: ['182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e'],
      from_ui: true,
      config_override: {
  ...
  test.skip('file: only required params', async () => {
    const responsePromise = client.v1.extraction.jobs.file({
      extraction_agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  ...
  test.skip('file: required and optional params', async () => {
    const response = await client.v1.extraction.jobs.file({
      extraction_agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      file: await toFile(Buffer.from('# my file contents'), 'README.md'),
      from_ui: true,
  ...
  test.skip('retrieveResult', async () => {
    const responsePromise = client.v1.extraction.jobs.retrieveResult('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveResult: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.extraction.jobs.retrieveResult(
