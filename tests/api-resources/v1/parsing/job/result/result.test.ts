...
describe('resource result', () => {
  test('getImage: required and optional params', async () => {
    const response = await client.v1.parsing.job.result.getImage('name', { job_id: 'job_id' });
  });

  // Prism tests are disabled
  test.skip('getJson', async () => {
    const responsePromise = client.v1.parsing.job.result.getJson('job_id');
  ...
  test.skip('getJson: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.parsing.job.result.getJson(
        'job_id',
  ...
  test.skip('getMarkdown', async () => {
    const responsePromise = client.v1.parsing.job.result.getMarkdown('job_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getMarkdown: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.v1.parsing.job.result.getMarkdown(
        'job_id',
        { organization_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' },
        { path: '/_stainless_unknown_path' },
      ),
  ...
  test.skip('getPdf', async () => {
    const responsePromise = client.v1.parsing.job.result.getPdf('job_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getStructured', async () => {
    const responsePromise = client.v1.parsing.job.result.getStructured('job_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getStructured: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.v1.parsing.job.result.getStructured(
        'job_id',
        { organization_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' },
        { path: '/_stainless_unknown_path' },
      ),
  ...
  test.skip('getText', async () => {
    const responsePromise = client.v1.parsing.job.result.getText('job_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getText: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.v1.parsing.job.result.getText(
        'job_id',
        { organization_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' },
        { path: '/_stainless_unknown_path' },
      ),
  ...
  test.skip('getXlsx', async () => {
    const responsePromise = client.v1.parsing.job.result.getXlsx('job_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
