...
describe('resource validateIntegrations', () => {
  ...
  test.skip('validateDataSinkConnection: only required params', async () => {
    const responsePromise = client.validateIntegrations.validateDataSinkConnection({
      component: { foo: 'bar' },
      name: 'name',
      sink_type: 'PINECONE',
    });
  ...
  test.skip('validateDataSinkConnection: required and optional params', async () => {
    const response = await client.validateIntegrations.validateDataSinkConnection({
      component: { foo: 'bar' },
      name: 'name',
      sink_type: 'PINECONE',
    });
  ...
  test.skip('validateDataSourceConnection: only required params', async () => {
    const responsePromise = client.validateIntegrations.validateDataSourceConnection({
      component: { foo: 'bar' },
      name: 'name',
      source_type: 'S3',
    });
  ...
  test.skip('validateDataSourceConnection: required and optional params', async () => {
    const response = await client.validateIntegrations.validateDataSourceConnection({
      component: { foo: 'bar' },
      name: 'name',
      source_type: 'S3',
  ...
  test.skip('validateEmbeddingConnection', async () => {
    const responsePromise = client.validateIntegrations.validateEmbeddingConnection({});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
